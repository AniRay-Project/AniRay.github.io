...
<html lang="en-US">
<head>
<title>AniRayProject</title>
<meta charset="utf-8">
<meta name="description" content="AniRay - это сайт информирования о происходящих Аниме Событиях.">
<meta name="keywords" content="AniRay, site, nhnt, hnt, loli, neko, anime, home">
...
<body>
<img src="/img/graphics/landing/Sis.png" width="1" height="1" alt="Preload"/>
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>AniRay Project<br>
							 </h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								AniRay - это сайт информирования о происходящих Аниме Событиях.
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/Sis.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="search-con-inner">
					<div class="search-inp-search darkmode-search-border">
						...
						<div class="search-con-author darkmode-txt">
							<a href="https://vk.com/toro_nl" target="_blank">
							<span class="darkmode-txt">add me /'_'\ <span class="search-img-author"></span>
							<span class="search-tx1-author"> Toro </span>
							</span>
							</a>
						</div>
					</div>
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							<div class="github-tx1-mantra darkmode-txt">
								<h2>Сделайте свой вклад сегодня!</h2>
							</div>
							<div class="github-tx2-mantra darkmode-txt">
								<p>
							
Мы всегда открыты для приветствия новых и талантливых разработчиков, которые помогут внести свой вклад в проект. APT, состоит из множества различных компонентов, требующих особого внимания к деталям и организации. С вашей помощью вы можете внести свой вклад в вывод APT на новый уровень.								</p>
							</div>
							<a href="https://www.patreon.com/AnimeProjectTEST" target="_blank">
					...
					<div class="patreon-con-mantra">
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							...
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
									 Мы предлагаем вам присоединиться к нашему патреону и поддержать нас! Чем вас больше, тем мы лучше!
								</p>
							</div>
							<a href="https://www.patreon.com/AnimeProjectTEST" target="_blank">
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 У нас есть свой Discord Сервер в котором мы делимся различной информацией с новыми пользователями и юными программистами!
								</p>
							</div>
